...
<div id="win" class="easyui-window" title="新增/编辑菜单信息" style="width:300px;height:385px;"
    ...
    <form id="ffff">
        ...
        <div>
            <input class="in" type="text" name="url" placeholder="路径"/>
        </div>
        <div>
            <input class="in" type="text" name="icon" placeholder="图标"/>
        </div>
        <div>
            <select id="parentId" class="easyui-combobox in" name="parent.id" style="width:200px;"
                    data-options="url:'/menu/parent',valueField:'id',textField:'name',value:'-1',editable:false"></select>
        </div>
