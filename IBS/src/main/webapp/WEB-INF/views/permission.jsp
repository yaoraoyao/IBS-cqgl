...
<div id="win" class="easyui-window" title="新增/编辑权限信息" style="width:300px;height:385px;"
    ...
    <form id="ffff">
        ...
        <div>
            <input class="in" type="text" name="url" placeholder="资源路径"/>
        </div>
        <div>
            <input class="in" type="text" name="descs" placeholder="描述"/>
        </div>
        <div>
            <input class="in" type="text" name="sn" placeholder="权限编码"/>
        </div>
        <div>
            <select id="menuId" class="easyui-combobox in" name="menu.id" style="width:200px;"
                    data-options="url:'/menu/child',valueField:'id',textField:'name',value:'-1',editable:false"></select>
        </div>
