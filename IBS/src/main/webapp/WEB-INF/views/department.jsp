...
<div id="win" class="easyui-window" title="新增/编辑部门信息" style="width:300px;height:385px;"
    ...
    <form id="ffff">
        ...
        <div>
            <input class="easyui-validatebox in" type="text" name="name" placeholder="部门名称" data-options="required:true"/>
        </div>
