...
<div id="win" class="easyui-window" title="新增/编辑数据字典明细信息" style="width:300px;height:385px;"
    ...
    <form id="ffff">
        ...
        <div>
            <input type="text" name="types.id" class="easyui-combobox in" id="types_id"
                   data-options="url:'/systemDictionaryType/findAll',valueField:'id',textField:'name',
                            editable:false,prompt:'请选择数据字典类型',panelHeight:'auto'" />
        </div>
