...
<div id="win" class="easyui-window" title="新增/编辑仓库信息" style="width:300px;height:385px;"
    ...
    <form id="ffff">
        ...
        <div>
            <input class="in" type="text" name="maxcapacity" placeholder="最大数量"/>
        </div>
        <div>
            <input class="in" type="text" name="currentcapacity" placeholder="当前数量"/>
        </div>
        <div>
            <input class="in" type="text" name="totalamount" placeholder="总价值"/>
        </div>
