...
<div id="toolbar">
    <form id="searchForm">
        ...
        送货日期：
        <input type="text" name="beginDate" class="in in-search easyui-datebox" data-options="editable:false,prompt:'开始日期'" />
        -
        <input type="text" name="endDate" class="in in-search easyui-datebox" data-options="editable:false,prompt:'结束日期'" />
...
<div id="win" class="easyui-window" title="新增/编辑入库单信息" style="width:800px;height:450px;padding:20px;"
    ...
    <form id="ffff">
        ...
        <div>
            <input type="text" name="vdate" class="easyui-datebox in" id="vdate" data-options="required:true,editable:false,prompt:'入库日期'" />
        </div>
        <div>
        ...
        <div>
            <input type="text" name="keeper.id" class="easyui-combobox in" id="keeperId"
                   data-options="required:true,editable:false,prompt:'请选择库管员',
                                url:'/employee/findAllKeeper',valueField:'id',textField:'userName'" />
        </div>
        <div>
            <input type="text" name="depot.id" class="easyui-combobox in" id="depotId"
                   data-options="required:true,editable:false,prompt:'请选择仓库',
                                url:'/depot/findAll',valueField:'id',textField:'name'" />
        </div>
    </form>
    <div style="clear: both;height: 5px;"></div>
    <table id="billItems"></table>
    <div id="billItems-tb">
        <a href="javascript:void(0);" id="btnInsert" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加</a>
