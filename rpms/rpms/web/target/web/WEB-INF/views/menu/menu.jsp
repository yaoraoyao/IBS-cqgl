        ...
        <el-main style="padding: 5px">
            ...
            <el-row>
                ...
                <el-table :data="tableData" stripe style="width: 100%;text-align: center;"
                    ...
                    <el-table-column prop="parent_id" label="上级菜单" width="180"></el-table-column>
                </el-table>
                <div class="block">
    ...
    var app = new Vue({
        ...
        methods:{
                ...
                if(this.multipleSelection !==null && this.multipleSelection.length !== 0){
                    this.$confirm('此操作将永久删除选中的数据吗?', '提示', {
                        ...
                        for(var i =0;i<this.multipleSelection.length;i++){
                            ...
                            let params = {id:id};
                            axios.post('/menu/delete?id='+id,params).then(function (response) {
            ...
            query(){
                ...
                axios.post('/menu/query',params).then(function (response) {
            ...
            onSubmit() {
                ...
                console.debug(params);
                _this = this;
                axios.post('/menu/save',params).then(function (response) {
                    if(response.data.success){
            ...
            loadData(){
                ...
                _this = this;
                axios.post('/menu/findAll',param).then(function (response) {
