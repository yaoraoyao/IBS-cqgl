    ...
    <el-container>
        <el-main>
            <el-row style="margin-bottom: 2px;" >
                <el-col :span="10" style="width:100px ;height: 40px ;">
                    <el-button-group >
            ...
            <el-row>
                <el-table :data="tableData" stripe style="width: 100%;text-align: center;"
                    ...
                    <el-table-column prop="sn" label="权限编码" width="180"></el-table-column>
                    <el-table-column prop="resource" label="资源" width="180"></el-table-column>
                    <el-table-column prop="menu_id" label="相关菜单" width="180"></el-table-column>
                </el-table>
                <div class="block">
    ...
    var app = new Vue({
        ...
        methods:{
                ...
                if(this.multipleSelection !==null && this.multipleSelection.length !== 0){
                    this.$confirm('此操作将永久删除选中的数据吗?', '提示', {
                        ...
                        for(var i =0;i<this.multipleSelection.length;i++){
                            ...
                            axios.get('/permission/delete?id='+id).then(function (response) {
            ...
            query(){
                ...
                _this=this;
                axios.post('/permission/query',params).then(function (response) {
            ...
            onSubmit() {
                ...
                _this = this;
                axios.post('/permission/save',params).then(function (response) {
                    if(response.data.success){
            ...
            loadData(){
                ...
                _this = this;
                axios.post('/permission/queryPage',param).then(function (response) {
